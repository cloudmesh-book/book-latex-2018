...
sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{\centering
    Handbook of \\ Big Data Applications and Analytics\\[15pt] % Book title
{\Large Theory and Practice}\\[20pt] % Subtitle
{\huge Gregor von Laszewski \\ \Large laszewski@gmail.com}}}; % Author name
\end{tikzpicture}
\vfill
\endgroup
...
\noindent Copyright \copyright\ 2017 Gregor von Laszewski\\

\noindent laszewski@gmail.com \\ % Copyright notice
