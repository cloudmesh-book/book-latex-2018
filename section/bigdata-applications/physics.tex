...
\chpater{Physics Case Studies}\label{physics-case-study}
...
\subsection{Physics Use Case II 2: With Python examples of Signal
plus
...
\subsection{Gaussian Distributions}\label{gaussian-distributions}
