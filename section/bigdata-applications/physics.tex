...
\sourcecode{Physics}{HiggsClassI-Sloping.py}{examples/python/physics/mr-higgs/higgs-classI-sloping.py}
...
\sourcecode{Physics}{HiggsClassI-Sloping.py}{examples/files/python/physics/mr-higgs/higgs-classI-sloping.py}

\sourcecode{Physics}{HiggsClassIII.py}{examples/python/physics/number-theory/higgs-classIII.py}

\sourcecode{Physics}{HiggsClassIIUniform.py}{examples/python/physics/mr-higgs/higgs-classII-uniform.py}
...
\sourcecode{Physics}{HiggsClassIII.py}{examples/python/physics/calculated-dice-roll/higgs-classIV-seeds.py}
