...
names and no special characters such as \verb|@ ; / _| and spaces. In general
...
\video{Github}{8:29}{Issues}{https://youtu.be/qozgBPQJx0A}
...
this coordination. Github provides such a feature through its 
\textit{issue} service that is embedded in each repository. 
...
Github uses markdown which we introduce you in Section~\ref{S:markdown}.
...
\URL{https://help.github.com/articles/about-teams/}
...
when you press the \verb|?| you will see a number of commands that allow you
...
A dashboard gives convenient overviews of the issues including a
\textit{pulse} that lists todo's status if you use them in the issue
description.
