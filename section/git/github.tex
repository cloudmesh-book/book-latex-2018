...
Figure \ref{a-??} shows where to find the link to the git issues. An
example issue list is shown in Figure \ref{b-??}
...
To carbon copy users in your issue text, simply use their github user name
