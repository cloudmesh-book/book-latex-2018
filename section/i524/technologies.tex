...
\subsection{Google Fusion Tables \cv}
...
as given in the blog~\cite{www-cloudfoundry-blog}, it delivers quick
application from development to deployment and is highly scalable. It
...
\subsection{dotCloud \cite{www-dotCloud} \cv}
...
\subsection{Public Cloud: Amazon SNS \cv}
...
\subsection{Megastore and Spanner \cv}
...
\subsection{Globus Online (GridFTP) \cv}
...
\subsection{Pivotal GPLOAD/GPFDIST \cv}
...
\subsection{Slurm \cite{www-slurm} \cv}
...
\subsection{OpenStack Ironic \cv}
...
\subsection{Google Kubernetes \cv}
