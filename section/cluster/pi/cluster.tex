...
From this table it is clear that we need to keep the Pi from throttling
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{br40a.png}
...
You have been presented in Section \ref
S:cluster-case-with-cooling-5-pi} with a table that compares
