...
\begin{figure}[!htbp]
\includegraphics[width=8cm,height=1.5cm]{section/icloud/assignment/problems/exercise5/p5-1}
\centering
...
\begin{figure}[!htbp]
\includegraphics[width=5cm,height=1cm]{section/icloud/assignment/problems/exercise5/p5-2}
\centering
...
\lstinputlisting[language=Java]{section/icloud/assignment/problems/exercise5/FibMapper.java}
