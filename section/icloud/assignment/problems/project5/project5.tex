...
\begin{document}\title{Project 5: HBase FreqIndexBuilder\\ Cloud Computing\\ Spring 2017}         % Enter your title between curly braces
...
\begin{figure}[!htbp]
\includegraphics[width=8cm,height=1.5cm]{p5-1}
\centering
...
\section*{What is Inverted Index?}
...
\begin{figure}[!htbp]
\includegraphics[width=5cm,height=1cm]{p5-2}
\centering
\caption{A sample inverted index}
\end{figure}

\section*{Mapper and Main Program}
...
\lstinputlisting[language=Java]{FibMapper.java}
...
\section*{Edit, compile and run your code}
