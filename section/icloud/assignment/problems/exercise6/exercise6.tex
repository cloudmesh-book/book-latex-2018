...
\begin{figure}[!htbp]
\includegraphics[width=8cm,height=6cm]{section/icloud/assignment/problems/exercise6/p6}
\centering
...
\lstinputlisting[language=Java]{section/icloud/assignment/problems/exercise6/SearchEngineTester.java}
