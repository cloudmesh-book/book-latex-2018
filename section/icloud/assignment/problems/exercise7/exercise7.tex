...
\begin{figure}[!htbp]
\includegraphics[width=6cm,height=8cm]{section/icloud/assignment/problems/exercise7/p8}
\centering
...
\lstinputlisting[language=Java]{section/icloud/assignment/problems/exercise7/computePartialPR.java}
