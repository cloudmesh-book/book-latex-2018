...
\slides{Cloud}{Google Search Engine 1}{15}{https://drive.google.com/open?id=0B88HKpainTSfYWZ0dDlrNThkVms}
...
\slides{Cloud}{Google Search Engine 2}{21}{https://drive.google.com/open?id=0B88HKpainTSfYWZ0dDlrNThkVms}
...
\slides{Cloud}{Hadoop PageRank}{1}{https://drive.google.com/open?id=0B88HKpainTSfWFpEZGxqSWRTYms}
...
\slides{Cloud}{Discussions and ParallelThinking}{10}{https://drive.google.com/open?id=0B88HKpainTSfWFpEZGxqSWRTYms}
...
\slides{Cloud}{Iterative MapReduce Models}{1}{https://drive.google.com/open?id=0B88HKpainTSfMFBaNHprbWJwQms}
...
\slides{Cloud}{Parallel Processes}{4}{https://drive.google.com/open?id=0B88HKpainTSfMFBaNHprbWJwQms}
...
\slides{Cloud}{Static and Variable Data}{10}{https://drive.google.com/open?id=0B88HKpainTSfMFBaNHprbWJwQms}
...
\slides{Cloud}{MapReduce Model Comparison}{24}{https://drive.google.com/open?id=0B88HKpainTSfMFBaNHprbWJwQms}
...
\slides{Cloud}{Twister K-means}{34}{https://drive.google.com/open?id=0B88HKpainTSfMFBaNHprbWJwQms}
...
\slides{Cloud}{Coding and Iterative Alternatives}{43}{https://drive.google.com/open?id=0B88HKpainTSfMFBaNHprbWJwQms}
