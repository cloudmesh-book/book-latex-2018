\part{How to Build a Search Engine(SaaS)}
...
\slides{Cloud}{Google Components}{1}{https://drive.google.com/open?id=0B88HKpainTSfYWZ0dDlrNThkVms}

\section{Google Architecture}

\video{Cloud}{8:40}{Google Architecture}{https://www.youtube.com/watch?v=syZHezdbdRY}

\slides{Cloud}{Google Architecture}{6}{https://drive.google.com/open?id=0B88HKpainTSfYWZ0dDlrNThkVms}
...
\slides{Cloud}{Google History}{14}{https://drive.google.com/open?id=0B88HKpainTSfYWZ0dDlrNThkVms}
