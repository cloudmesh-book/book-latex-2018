...
\subsection{Introduction - Part F - Technology Hypecycle I}\label{s:cloud-fundamentals-f}
...
\subsection{Introduction - Part H - IaaS I}\label{s:cloud-fundamentals-h}
...
\subsection{Introduction - Part K - Applications I}\label{s:cloud-fundamentals-k}
...
\subsection{Introduction - Part L - Applications II}\label{s:cloud-fundamentals-l}
...
\subsection{Introduction - Part M - Applications III}\label{s:cloud-fundamentals-m}
...
\subsection{Introduction - Part N - Parallelism}\label{s:cloud-fundamentals-n}
...
\subsection{Introduction - Part O - Storage}\label{s:cloud-fundamentals-o}
...
\subsection{Introduction - Part P - HPC in the Cloud}\label{s:cloud-fundamentals-p}
...
\subsection{Introduction - Part T - Security}\label{s:cloud-fundamentals-t} 
...
\subsection{Introduction - Part U - Fault Tolerance}\label{s:cloud-fundamentals-u}
