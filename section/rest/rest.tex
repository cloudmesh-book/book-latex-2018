...
use a function called \textbf{the_student_john}.

\subsection{Consuming REST API Using a Client Application}

In the Section \ref{s:rest-api-endpoints} we created our own REST API application using
Python Eve. Now once the service running, a we need to learn how to
