...
as we show you how to gain access to the data via mongo while not
using REST calls.   Instead while using REST we can simply retrieve
...
\begin{exercise}
What is the meining and purpose of links, child, and href
\end{exercise}
