...
(Piazza.1) Enroll in piazza
\end{exercise}

\begin{exercise}\label{E:Piazza.2}
  (Piazza.2) Post a short formal bio in the bio folder and optionally
...
\begin{exercise}\label{E:Piazza.3}
  (Piazza.3) How do you find out within Piazza which assignments have
  been posted?
\end{exercise}

\begin{exercise}\label{E:Piazza.4}
  (Piazza.4) Please watch the Video about Piazza
\end{exercise}
