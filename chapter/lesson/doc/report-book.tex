\begin{fileremark}
\url{chapter/doc/report-book.tex}
\end{fileremark}
...
services such as sharelatex \cite{??} and overleaf \cite{??}.
...
\subsection{Paper Checklist}\label{paper-checklist}
...
\item
  Have you included the paper in the submission system (In our class it
  is git)?
\item
  Have you specified proper identification in the submission system.
  THis is typically a form or ASCII text that needs to be filled out (In
  our case it is a README.md file that includes a homework ID, names of
  the authors, and e-mails)?
\item
  Have you included all images in native and PDF format in the
  submission system?
\item
  Have you added the bibliography file that you managed (In our case
  jabref to make it simple for you)?
\item
  In case you used word have you also provided the jabref?
\item
  In case of a class and if you do a multi-author paper, have you added
  an appendix describing who did what in the paper?
\item
...
\item
  Have you removed any figure that is not referred explicitly in the
...
\item
  ...
  copyright permission. IN case of a class paper you \textbf{must}
  include a reference to the original in the caption.
\item
...
\item
  Do not artificially inflate your paper if you are bellow the page
...
\item
  Latex uses double single open quotes and double single closed quotes
  for quotes. Have you made sure you replaced them?
\item
  Pasting and copying from the Web often results in non ascii characters
  to be used in your text, please remove them and replace accordingly.
\end{itemize}
...
\item
  Check in your current work of the paper on a weekly basis to show
  consistent progress.
\item
