\begin{fileremark}\url{https://github.com/cloudmesh/classes/blob/master/docs/source/i523/2017/course/lifestyle.rst}\end{fileremark}
...
\slides{Recommender}{45}{https://drive.google.com/open?id=0B6wqDMIyK2P7YkIwczVfQlJqVG8}{PDF}
...
\slides{Recommender}{49}{https://drive.google.com/open?id=0B6wqDMIyK2P7UVloVElaZ2FXcTg}{PDF}
...
\video{8:46}{Recap of Recommender Systems II}{https://youtu.be/FBn7HpGFNvg}

\video{10:48}{Recap of Recommender Systems III}{https://youtu.be/VS2Y4lAiP5A}

\video{3:21}{Case Study of Recommender systems}{https://youtu.be/HrRJWEF8EfU}
...
\video{7:20}{User-based nearest-neighbor collaborative filtering I}{https://youtu.be/lsf_AE-8dSk}

\video{7:29}{User-based nearest-neighbor collaborative filtering II}{https://youtu.be/U7-qeX2ItPk}
...
\slides{Filtering}{18}{https://drive.google.com/open?id=0B6wqDMIyK2P7UExxVFc5YlpOZ28}{PDF}
...
\video{11:18}{Item Based Filtering}{https://www.youtube.com/watch?v=HTdYGaOTlFI}

\video{7:16}{k Nearest Neighbors and High Dimensional Spaces}{https://youtu.be/SM8EJdAa4mw}
