...
\subsection{Red Hat OpenShift -o-}
...
\subsection{Azure Stream Analytics -o-}
...
\subsection{Pivotal GPLOAD/GPFDIST -o-}
...
\subsection{Google Cloud Storage -o-}
...
\subsubsection{OpenStack Keystone -o-}
