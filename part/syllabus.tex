...
\WHERE{\NO}{c:doc}{Month 1}
\WHERE{\NO}{S:plagiarism}{Month 1}
\WHERE{\NO}{S:writing}{Month 1}
\WHERE{\NO}{C:latex}{Month 1}
\WHERE{\NO}{C:bibtex}{Month 1}
\WHERE{\NO}{C:emacs}{Optional, highly recommended}
\WHERE{\NO}{S:markdown}{Month 1}
\WHERE{\NO}{S:results}{Week 1}
...
\WHERE{\NO}{C:emacs}{Week 2}

\WHERE{\NO}{S:writing}{Week 3}
\WHERE{\NO}{C:latex}{Week 3}
\WHERE{\NO}{C:bibtex}{Week 4}
...
\WHERE{\NO}{C:python}{Week 3 - 4}
\WHERE{\NO}{C:python-install}{Week ?}
\WHERE{\NO}{C:python-language}{Week ?}
\WHERE{\NO}{C:python-lib}{Week ?}
...
\WHERE{\NO}{C:chameleon}{Week 4}
\WHERE{\NO}{C:cc-charge}{Week 4}
\WHERE{\NO}{C:cc-hardware}{Week 4}
\WHERE{\NO}{C:cc-start}{Week 4}
\WHERE{\NO}{C:cc-horizon}{Week 5}
\WHERE{\NO}{C:cc-guide}{Week 4}
