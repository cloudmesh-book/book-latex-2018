...
\WHERE{\YES}{s:cloud-fundamentals-a}{Cloud}
\WHERE{\YES}{s:cloud-fundamentals-b}{Cloud}
\WHERE{\YES}{s:cloud-fundamentals-c}{Cloud}
\WHERE{\YES}{s:cloud-fundamentals-d}{Cloud}
\WHERE{\YES}{s:cloud-fundamentals-e}{Cloud}
\WHERE{\YES}{s:cloud-fundamentals-f}{Cloud}
\WHERE{\YES}{s:cloud-fundamentals-g}{Cloud}
\WHERE{\YES}{s:cloud-fundamentals-h}{Cloud}
\WHERE{\YES}{s:cloud-fundamentals-i}{Cloud}
