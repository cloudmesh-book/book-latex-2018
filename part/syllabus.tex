...
\subsection{Week 1 and 3. Introdcution to Cloud Computing}

A number of presentations have been posted to introduce you to ths
Class.

\TODO{Tyler: include the links to Geoffreys lecture he presented}

This introduction has been continued in Week 3 of the class by
Geoffrey posting additional lectures.

\TODO{Tyler: include the links to Geoffreys lectures he presented}


\subsection{Week 2. REST for Cloud computing }
...
\TODO{TYler: work with 505 to rename everest to rest, ubdate handbook
  when done}
...
\TODO{Tyler: add url to assignment on piazza. Describe how each
  student gets a unique assignment. Coordinate that assignment.}


\subsection{Week 2-3. Setting up your development environment}
...
\subsection{Week 4. Introduction to simple Containers}
...
\subsection{Week 5. Introduction to Container Clusters}
...
\subsection{Week 7. Overview of Cloud Services}
...
\subsection{Week 8. Multi cloud environments}
...
\subsection{Week 8. Cloud Data and Applications}
