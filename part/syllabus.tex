...
\item[Week 8] Feb 26
\item[Week 9] Mar 5
\item[Week 10] Mar 11 - Mar 18 Spring break starts
\item[Week 11] Mar 19 
\item[Week 12] Mar 26
\item[Week 13] Apr 2
\item[Week 14] Apr 9
...
Python will be used as a Programming Language. In some cases Java may
also be useful however its use in class will be marginal. The class
will be using Linux commandline tools. Prior knowledge of Linux is of
advantage but not required.  Students are expected to have access to a
...
\input{section/preface/graph-e516}
...
\paragraph{Big Data Applications}

\WHERE{\YES}{s:nist-usecase}{Available Jan 1, 2018, Released Mar 10, 2018}
...
v  recommend you use Ubuntu.
\end{description}

\subsubsection{Python}

\WHERE{\YES}{C:python}{Week 3 - 4}
\WHERE{\YES}{C:python-install}{Week 3}
\WHERE{\YES}{C:python-language}{Week 3}
...
\input{section/preface/graph-e616}
...
\WHERE{\YES}{a:616-bio}{Exercise~\ref{E:616-bio-piazza},~\ref{E:616-bio-googledocs},~\ref{E:616-iu-google} Due: Jan  22, 2018}
\WHERE{\YES}{E:616-bigdata-collab}{Due: Jan 29, 2018}
\WHERE{\YES}{E:616-new-tech}{Due: Jan 29, 2018}
\WHERE{\YES}{E:616-new-tech-abstract}{Due: Jan 29, 2018}
...
\WHERE{\YES}{p:bigdata}{Available Jan 1. 2018, Released Mar 10, 2018}

This section includes a number of lectures in various application domains

\WHERE{\YES}{s:nist-usecase}{Available Jan 1. 2018, Released Mar 10, 2018}
\WHERE{\YES}{c:health-informatics}{Available Jan 1. 2018, Released Mar 10, 2018}
\WHERE{\YES}{c:e-commerce}{Available Jan 1. 2018, Released Mar 10, 2018}
\WHERE{\YES}{c:physics}{Available Jan 1. 2018, Released Mar 10, 2018}
\WHERE{\YES}{c:sensors}{Available Jan 1. 2018, Released Mar 10, 2018}
\WHERE{\YES}{c:sports}{Available Jan 1. 2018, Released Mar 10, 2018}
\WHERE{\YES}{c:websearch}{Available Jan 1. 2018, Released Mar 10, 2018}
...
\input{section/preface/graph-e222}
