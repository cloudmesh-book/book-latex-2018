...
\chapter{Introduction}\label{S:p-int
...
\textit{Contributed by the Chameleon Team and Gregor von Laszewski}

Chapter~\ref{C:chameleon} focussing on Chameleon Cloud was copied
...
2017, but was significantly modified in Spring 2018.
