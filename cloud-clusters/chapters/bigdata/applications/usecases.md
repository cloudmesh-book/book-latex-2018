...
[:scroll: Overview (45)](https://drive.google.com/open?id=0B8936_ytjfjmODIxNGttU1pveWc)
...
[:clapper: Introduction (13:02)](https://www.youtube.com/watch?v=3oKdmuH0N3k)
...
[:clapper: Taxonomies (7:42)](https://www.youtube.com/watch?v=7eOtuBV8udo)
...
[:clapper: Architecture (10:05)](https://www.youtube.com/watch?v=h4ylW0vztDw)
...
[:clapper: Technology (4:14)](https://www.youtube.com/watch?v=va0UCR5gMTA)
...
[:clapper: Requirements (27:28)](https://www.youtube.com/watch?v=f_vxmx3CmMU)
...
[:scroll: 51 Use Cases (100)](https://drive.google.com/open?id=0B8936_ytjfjmYUlKckhLSUQxMUk)
...
[:clapper: Government Use Cases (17:43)](https://www.youtube.com/watch?v=e0ks_BuYUVM)
...
[:clapper: Commercial Use Cases (17:43)](https://www.youtube.com/watch?v=URy9u8_34ww)
...
[:clapper: Defense Use Cases (15:43)](https://www.youtube.com/watch?v=FXFfE8zcco8)
...
[:clapper: Healthcare and Life Science Use Cases (30:11)](https://www.youtube.com/watch?v=uGeYrXENlpU)
...
[:clapper: Deep Learning and Social Networks Use Cases (14:19)](https://www.youtube.com/watch?v=bdWyhT8bvE4)
...
[:clapper: Research Ecosystem Use Cases (9:09)](https://www.youtube.com/watch?v=jjyv4RmMIUU)
...
[:clapper: Astronomy and Physics Use Cases (17:33)](https://www.youtube.com/watch?v=MPEe8yDVwAo)
...
[:clapper: Environment, Earth and Polar Science Use Cases (25:29)](https://www.youtube.com/watch?v=YJGk-uvaUCg)

### Energy Use Case

This covers Consumption forecasting in Smart Grids.

[:clapper: Energy Use Case (4:01)](https://www.youtube.com/watch?v=5y_O-a8_Fbg)
...
[:scroll: Features (43)](https://drive.google.com/open?id=0B8936_ytjfjmREJTMHhjMktXRHc)
...
[:clapper: Summary of Use Case Classification (23:39)](https://www.youtube.com/watch?v=X0vEmbn1Ld8)
...
[:clapper: Database (SQL) Use Case Classification (11:13)](https://www.youtube.com/watch?v=jIVdQID11Q4)
...
[:clapper: NoSQL Use Case Classification (11:20)](https://www.youtube.com/watch?v=uGL8cFPrhoE)
...
[:clapper: Use Case Classifications I (12:42)](https://www.youtube.com/watch?v=79IwNCNjVWU)
...
[:clapper: Use Case Classifications II (20:18)](https://www.youtube.com/watch?v=b-olNbWCJyg)
...
[:clapper: Use Case Classifications III (17:25)](https://www.youtube.com/watch?v=ewqoFGxyQmc)
...
-   Use Case 16 Electronic Medical Record (EMR) Data:
    ...
    - [Logical observation
    identifiers names and codes](http://loinc.org/)
    - [Indiana Health
    Information Exchange](http://www.ihie.org/)
    - [Institute of Medicine Learning Healthcare
    System](http://www.iom.edu/Activities/Quality/LearningHealthcare.aspx)
-   Use Case 17
    - [Pathology Imaging/digital pathology](https://web.cci.emory.edu/confluence/display/PAIS>)
...
-   [Use Case 31 NIST Information Access Division analytic technology
    performance measurement, evaluations, and standards](http://www.nist.gov/itl/iad/)
-   Use Case 32
    - DataNet Federation Consortium DFC: [The DataNet
    Federation Consortium](http://datafed.org/),
    - [iRODS](http://irods.org/)
-   Use Case 33 The 'Discinnet process', [big data
...
-   Use Case 36
    ...
    - For an [overview of the classification challenges](http://arxiv.org/abs/1209.1681)
...
-   Use Case 42 ENVRI, Common Operations of Environmental Research
    ...
    - [ENVRI deliverable D3.2 : Analysis of common requirements of Environmental Research
